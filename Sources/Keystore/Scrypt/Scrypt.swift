...
//            V.deallocate(bytes: 128 * params.r * params.n, alignedTo: 64)
        ...
        let barray = try PKCS5.PBKDF2(password: password, salt: [UInt8](salt), iterations: 1, keyLength: params.p * 128 * params.r, variant: .sha2(.sha256)).calculate()
        ...
        return try PKCS5.PBKDF2(password: password, salt: block, iterations: 1, keyLength: params.desiredKeyLength, variant: .sha2(.sha256)).calculate()
    }
